...
clean:
	...
	terraform destroy -var="plural_console_url=$(PLURAL_CONSOLE_URL)" -var="plural_console_token=$(PLURAL_CONSOLE_TOKEN)" -var="dockerhub_username=$(DOCKERHUB_USERNAME)" -var="dockerhub_access_token=$(DOCKERHUB_ACCESS_TOKEN)"
